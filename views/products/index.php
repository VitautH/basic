            ...
            <div class="bonus_plan_steps col-lg-8 col-xs-12 col-sm-12">
               <div class="step left_top col-lg-5 col-xs-12 col-sm-5">
                ...
                <div class="step top col-lg-5 col-xs-12 col-sm-5">
                    ...
                    <div class="action"><span>Выбираете план</span></div>
                </div>
                ...
                <div class="step bottom col-lg-5 col-xs-12 col-sm-5">
                    ...
                    <div class="action"><span>Получаете  бонус-план</span></div>
                </div>
            </div>
        </div>
    </div>
...
endforeach;
                ...
                <select name="casino" class="form-control">
                    ...
                    <div class="price_block col-sm-4 col-lg-12">
                        <h4>Стоимость плана (в у.е)</h4>
                        <input type="number" name="min_price" step="1" min="0" max="100000" placeholder="от">
                        <input type="number" name="max_price" step="1" min="0" max="100000" placeholder="до">
                    </div>
                    ...
                    <div  id="filter_submit"> Искать</div>
                    <?php ActiveForm::end() ?>
</div>
