...
<div class="coupon_table_body col-lg-12 col-xs-12" id="coupon_table_body_<?= $order->id ?>">
    ...
    if ($order->coupons['status'] == Coupon::USED) : ?>
        <div class="account-actions col-lg-4 col-xs-12 col-sm-2 button-extinguished">
            ...
            <span class="casino-button button-unused button-delete"><a href="/order-hide/<?= $order->id ?>"
                                                                       class="delete"
                                                                       data-delet="<?= $order->id ?>"><?= _t('Удалить'); ?></a></span>
        </div>
    <? endif; ?>
</div>
...
<div class="col-lg-12 col-xs-12">
       <h3 style="text-align: center"><?=_t('Заказы не найдены! Измените параметры  фильтра');?></h3>
</div>
    </div>
        <?
endif;
